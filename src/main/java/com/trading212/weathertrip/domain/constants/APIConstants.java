...
public class APIConstants {
    ...
    public static final String HOTEL_SEARCH_URL = "https://booking-com.p.rapidapi.com/v2/hotels/search?dest_type=hotel&order_by=popularity&adults_number=2&checkin_date=";
