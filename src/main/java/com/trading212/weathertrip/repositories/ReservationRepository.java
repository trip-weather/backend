...
public class ReservationRepository {
    ...
    public void save(Reservation reservation) {
        String sql = "insert into reservations(user_uuid, hotel_uuid, order_uuid, reservation_date, check_in_date, check_out_date, price) VALUES (?,  ?, ?, ?, ?, ?, ?)";
    ...
    public Optional<ReservationDTO> getReservationByOrderUuid(String uuid) {
        ...
        String sql = "select check_in_date, check_out_date, price, h.name, h.city, h.photo_main_url, o.payment_status from reservations\n" +
                "join orders o on reservations.order_uuid = o.uuid\n" +
                "join hotels h on h.uuid = reservations.hotel_uuid                                                                    \n" +
                "where order_uuid = ?";
